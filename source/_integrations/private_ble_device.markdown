...
8. Select a frame with your phone in the "Source" column and expand the "Bluetooth Security Manager Protocol." Copy the value of "Identity Resolving Key".
   <details>
   <summary><b>Click here</b> for troubleshooting advice</summary>

    - In case you searched for `_ws.col.info matches "Sent LE Add Device to Resolving List"`, select any frame, expand "Bluetooth HCI Command - LE Add Device to Resolving List" and copy the value of "Local IRK".
